...
'''
Considerando o código abaixo do arquivo main.py , continue a implementação do agente de trading
'''
...
# testando a GPU do computador
print("Num GPUs Available: ", len(tf.config.experimental.list_physical_devices('GPU')))
print(tf.config.experimental.list_physical_devices('GPU'))


# carregar dados
data = pd.read_csv('libs/win_dia.csv')
...
avaliacao_random = TradingDataStore()
env = B3(data)
agente = Agente() # 3 ações: 0, 1, 2

# print('Verificando se o ambiente está funcionando corretamente...')
# print('Observação inicial:', env.reset())
# print('Ação aleatória:', env.step(np.random.randint(3)))
